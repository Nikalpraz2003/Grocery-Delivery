...
import { ArrowUpRightIcon, BikeIcon, ChevronDownIcon, SearchIcon, ShoppingCartIcon } from "lucide-react";
                        ...
                        <div className="flex-center gap-2">
                          ...
                          {userMenuOpen && (
                            ...
                            border-app-border py-2 z-50 animate-fade-in">
                                ...
                                {!user && <Link to='login'> <UserIcon size=
                                {16} /> Register </Link>}
                                ...
                                <Link to='/products'
                                className="dropdown-link md:hidden"><ArrowUpRightIcon size=
                                {16} />  My Products</Link>
